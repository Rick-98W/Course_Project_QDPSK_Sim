...
import config
from analysis import compute_eye_traces, compute_psd, sample_constellation
from bitstream import bits_to_bytes, bytes_to_bits
from channel import apply_channel, channel_summary
from image_source import build_image_frame, load_source_image
...
from packet import CHANNEL_QDPSK, CHANNEL_QPSK, fragment_iq_stream
from preview_dump import write_packet_preview
from plotter import render_all_tx_plots, render_constellation_png, render_eye_png
from udp_sender import send_packets
...
def run_transmitter_pipeline(
    ...
    source = load_source_image(config.IMAGE_PATH)
